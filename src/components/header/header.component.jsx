 ...
 <div className='Header container'>
                ...
                <div className="Options">
                    ...
                    <span
                        ...
                        className="Option MenuToggle">
                        X
                    </span>
                </div>
                <div className={this.state.menuBar? "SideBar Show" : "SideBar"}>
                <NavLink activeClassName="ActiveLink" className='SideBarOptions' to="/shop">SHOP</NavLink>
                    <NavLink activeClassName="ActiveLink" className='SideBarOptions' to="/contact">CONTACT</NavLink>
                    {
                        currentUser ?
                        <div 
                        ...
                        >SIGN OUT</div> :
                        <NavLink activeClassName="ActiveLink" className='SideBarOptions' to="/signin">SIGN IN</NavLink>
                    }
                </div>
